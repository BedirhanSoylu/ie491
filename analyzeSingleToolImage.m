function [edge_radius_px, tool_length_px, worn_area_px] = analyzeSingleToolImage(imgPath)
...
% only need to supply the single worn image path.
    ...
    [edge_radius_px, tool_length_px, worn_area_px] = agent_worn_area(imgPath, freshImgPath);
end
